...
public class EmployeController {
    ...
    @PostMapping("/with-entreprise")
    public ResponseEntity<Employe> createEmployeWithEntreprise(@RequestBody EmployeDTO dto) {
        Employe employe = employeService.createEmployeWithEntreprise(dto);
